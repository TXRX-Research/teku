...
var MIN_GENESIS_ACTIVE_VALIDATOR_COUNT = uint64((2uL.pow(14uL)))
var MIN_GENESIS_TIME = uint64(1578009600uL)
...
var SLOTS_PER_HISTORICAL_ROOT = uint64((2uL.pow(13uL)))
val MIN_VALIDATOR_WITHDRAWABILITY_DELAY = uint64((2uL.pow(8uL)))
var SHARD_COMMITTEE_PERIOD = uint64((2uL.pow(8uL)))
var EPOCHS_PER_HISTORICAL_VECTOR = uint64((2uL.pow(16uL)))
var EPOCHS_PER_SLASHINGS_VECTOR = uint64((2uL.pow(13uL)))
...
var PHASE_1_FORK_SLOT = Slot(0uL)
var INITIAL_ACTIVE_SHARDS = (2uL.pow(6uL))
