...
public class BeaconBlockBody
  ...
  public static class BeaconBlockBodyType
    ...
    public BeaconBlockBodyType() {
      super(
          ...
          namedType("executable_data", ExecutableData.TYPE.get()),
          namedType(
              "proposer_slashings",
    ...
    public ListViewType<ProposerSlashing> getProposerSlashingsType() {
      return (ListViewType<ProposerSlashing>) getFieldType4();
    }

    public ListViewType<AttesterSlashing> getAttesterSlashingsType() {
      return (ListViewType<AttesterSlashing>) getFieldType5();
    }

    public ListViewType<Attestation> getAttestationsType() {
      return (ListViewType<Attestation>) getFieldType6();
    }

    public ListViewType<Deposit> getDepositsType() {
      return (ListViewType<Deposit>) getFieldType7();
    }

    public ListViewType<SignedVoluntaryExit> getVoluntaryExitsType() {
      return (ListViewType<SignedVoluntaryExit>) getFieldType8();
    }
  ...
  public SSZList<ProposerSlashing> getProposer_slashings() {
    return new SSZBackingList<>(
        ProposerSlashing.class, getField4(), Function.identity(), Function.identity());
  }

  public SSZList<AttesterSlashing> getAttester_slashings() {
    return new SSZBackingList<>(
        AttesterSlashing.class, getField5(), Function.identity(), Function.identity());
  }

  public SSZList<Attestation> getAttestations() {
    return new SSZBackingList<>(
        Attestation.class, getField6(), Function.identity(), Function.identity());
  }

  public SSZList<Deposit> getDeposits() {
    return new SSZBackingList<>(
        Deposit.class, getField7(), Function.identity(), Function.identity());
  }

  public SSZList<SignedVoluntaryExit> getVoluntary_exits() {
    return new SSZBackingList<>(
        SignedVoluntaryExit.class, getField8(), Function.identity(), Function.identity());
  }
}
